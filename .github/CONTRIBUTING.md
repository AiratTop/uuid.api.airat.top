...
Thanks for your interest in improving uuid.api.airat.top. Contributions are welcome, including bug reports, docs improvements, and API behavior refinements.
...
2. Create a feature branch that describes your work (for example, `feature/add-version-7`).
...
- [ ] Default `GET /` returns UUID v4.
- [ ] `?version=7` returns UUID v7.
- [ ] Invalid `version` returns documented 400 JSON error.
- [ ] `plain=1` behavior remains correct.
